...
class PessoasControllerTest < ActionController::TestCase
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post :create, pessoa: { caracteristicas: @pessoa.caracteristicas, foto: @pessoa.foto, nome: @pessoa.nome }
    end
  ...
  test "should update pessoa" do
    put :update, id: @pessoa, pessoa: { caracteristicas: @pessoa.caracteristicas, foto: @pessoa.foto, nome: @pessoa.nome }
    assert_redirected_to pessoa_path(assigns(:pessoa))
  end
